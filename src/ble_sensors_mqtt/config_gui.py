...
def run_gui() -> int:
    ...
    add_entry(general, 1, "bluetooth.scan_duration", "BLE scan duration (s)", section("bluetooth").get("scan_duration", 10))
    ...
    add_entry(general, 4, "runtime.sensor_retry_attempts", "BLE acquisition attempts per polling cycle", section("runtime").get("sensor_retry_attempts", 3))
